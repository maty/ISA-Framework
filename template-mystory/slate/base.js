...
Luca.Experiments.registerExperiment({
    ...
    cohorts: {
        'base-bumper-new': function( version ) {
            if ( !sameDomainIframe() ) {
                topBar( 'reader_slate_topbar_createyourown', 'Create Your Own' );
            }
